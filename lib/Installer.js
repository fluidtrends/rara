            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, _1.Registry.npm(command + " " + options.join(' '))];
                    case 1:
                        _a.sent();
    ...
    Installer.prototype.install = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this._npm('install', ['--only=prod', '--no-warnings', '--loglevel=error', '--no-progress', '--silent', '--no-audit'])];
            });
        });
    };
    return Installer;
