...
var Installer = /** @class */ (function () {
    ...
    Installer.prototype._npmInstall = function (msg) {
        return __awaiter(this, void 0, void 0, function () {
            var startTime, installed, totalTime;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        startTime = Date.now();
                        return [4 /*yield*/, _1.Registry.install({
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, __assign({ totalTime: totalTime, installed: true }, installed)];
                }
            });
        });
    };
    Installer.prototype.install = function (msg) {
        return __awaiter(this, void 0, void 0, function () {
            var npmManifest;
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this._npmInstall(msg)];
            });
        });
    };
    return Installer;
