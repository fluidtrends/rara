...
var Archive = /** @class */ (function () {
    ...
    Archive.prototype.installDependencies = function (msg) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [2 /*return*/, this.installer.install(msg)];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, _1.Registry.extract(this.archiveId, this.path)];
